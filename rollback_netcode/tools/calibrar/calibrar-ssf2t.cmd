...
echo.
echo   Calibragem de ssf2t
echo   ===================
echo.
echo   O ssf2t ainda nao tem endereco de vida nem de personagem mapeado,
...
:roda
echo.
fbneo64d.exe ssf2t -w -noscan -rbfprobe
echo.
echo   Arquivos gerados:
dir /b rbf-probe-ssf2t-*.rbfp 2>nul || echo     (nenhum - veja rbf-netplay.log)
echo.
